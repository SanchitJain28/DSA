...
// (This is the boss fight we queued up yesterday. It forces you to
// combine standard Binary Search with boundary-checking logic.
// Draw this one out on paper first.)
...
function search(nums: number[], target: number): number {
  ...
  //First find the minumum element
  while (left < right) {
