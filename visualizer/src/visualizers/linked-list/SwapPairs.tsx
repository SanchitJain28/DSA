...
interface SwapPairsData {
  values: number[];
}

type SwapPairsTestCase = TestCase<SwapPairsData>;

const TEST_CASES: SwapPairsTestCase[] = [
  {
    id: "tc1",
...
export default function SwapPairs() {
  ...
  const [currentData, setCurrentData] = useState<SwapPairsData>(
    TEST_CASES[0].data!,
  );
