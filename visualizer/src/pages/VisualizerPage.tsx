...
// Migrated Problems Modules (New Architecture)
...
const MIGRATED_PROBLEMS: Record<
  string,
  {
...
function GenericProblemRunner({ problemKey }: { problemKey: string }) {
  const problem = MIGRATED_PROBLEMS[problemKey];
...
export default function VisualizerPage() {
  ...
  const isMigrated = activeTab in MIGRATED_PROBLEMS;
